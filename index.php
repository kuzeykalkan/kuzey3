...
/// premium üyelere bildirim

$kontrolpush = $_SESSION['kontrolpush'];

if ($kontrolpush === true) {

if($sm['user']['premium'] == 0){
    
 redirect('https://kissmeet.online/testnoti.php');
...
// Kontrol değerini session'dan okuyun
$kontrol = $_SESSION['kontrol'];

// Her seferinde fonksiyonu çalıştırın
if ($kontrol === true) {
  // Fonksiyonu çalıştırın
 
  pre5();
} else {
  // Fonksiyonu çalıştırmayın
}

// Kontrol değerini her seferinde sıfırlayın
$_SESSION['kontrol'] = false;
...
//500 kredi bşalnangıç



// Kontrol değerini session'dan okuyun
$kontrol6 = $_SESSION['kontrol6'];
